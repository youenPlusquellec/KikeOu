...
class CoworkersFragment:Fragment(R.layout.fragment_coworkers) {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val agenda2 = Agenda(2, "papa" ,52, "", listOf(contact1, contact2), listOf(loc1, loc2), false)
        val agenda3 = Agenda(3, "moi" ,50, "", listOf(contact1, contact2), listOf(loc1, loc2), false)
